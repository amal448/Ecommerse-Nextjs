...
import { ArrowRight, ArrowRightIcon, Trash2 } from "lucide-react";
...
const CartPage = () => {
    ...
    const searchParams = useSearchParams() //get the current step
    const router = useRouter()//for adding step to url
                                ...
                                <div className="flex items-center justify-between" key={item.id +item.selectedSize +item.selectedColor}>
                                    ...
                                    <div className="flex gap-8">
                                        <div className="relative w-32 h-32 bg-gray-50 rounded-lg overflow-hidden">
                                            <Image src={item.images[item.selectedColor]} alt={item.name} fill
                                    ...
                                    {/* DELETE BUTTON */}
                                    <button onClick={()=>removeFromCart(item)} className="w-8 h-8 rounded-full bg-red-100 hover:bg-red-200 transition-all duration-300 text-red-400 flex justify-center items-center cursor-pointer ">
                ...
                <div className="w-full h-max lg:w-5/12 shadow-lg border-1 border-gray-100 p-8 rounded-lg flex flex-col gap-8">
                    ...
                    </div>
                    {
                        activeStep === 1 && (
                            ...
                            <button onClick={() => router.push("/cart?step=2", { scroll: false })} className="w-full bg-gray-800 hover:bg-gray-900 transition-all duration-300 text-white p-2 rounded-lg cursor-pointer flex justify-center items-center gap-2  ">
                                Continue
